<div>
                        ...
                        <tr class="hover:bg-gradient-to-r hover:from-indigo-50/50 hover:to-purple-50/50 transition-colors duration-150">
                            ...
                            <td class="px-6 py-4 text-right">
                                <div class="flex justify-end space-x-2">
                                    <button wire:click="edit({{ $attendance->id }})" class="inline-flex items-center px-3 py-2 text-sm font-medium text-indigo-600 hover:text-indigo-800 hover:bg-indigo-50 rounded-lg transition-colors duration-150">
                                        <svg class="w-4 h-4 mr-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z"></path>
                                        </svg>
                                        Ubah
                                    </button>
                                    <button wire:click="confirmDelete({{ $attendance->id }})" class="inline-flex items-center px-3 py-2 text-sm font-medium text-red-600 hover:text-red-800 hover:bg-red-50 rounded-lg transition-colors duration-150">
                                        <svg class="w-4 h-4 mr-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        <tr>
                            <td colspan="6" class="px-6 py-12 text-center">
                                <div class="flex flex-col items-center justify-center">
                                    ...
                                    <p class="text-gray-500">Mulai dengan menambahkan data kehadiran pertama.</p>
                                </div>
                            </td>
                        </tr>
                    @endforelse
    ...
    <!-- Create/Edit Modal -->
    <div x-data="{ open: @entangle('showAttendanceModal') }" class="p-4" x-cloak>
        <!-- Wrapper -->
                    ...
                    <div class="flex justify-between items-center">
                        <div>
                            <h2 class="text-2xl font-bold text-white mb-1">
                                {{ $attendance_id ? 'Edit Kehadiran' : 'Tambah Kehadiran Baru' }}
                            </h2>
                            <p class="text-indigo-100">
                                {{ $attendance_id ? 'Perbarui catatan kehadiran' : 'Tambahkan catatan kehadiran baru' }}
                            </p>
                        </div>
                        ...
                        <div class="flex justify-end space-x-4 pt-6 border-t border-gray-200">
                            ...
                            <button type="submit" 
                                ...
                                <span class="flex items-center">
                                    ...
                                    {{ $attendance_id ? 'Perbarui Kehadiran' : 'Buat Kehadiran' }}
                                </span>
                            </button>
                        </div>
                    </form>
        ...
        <div x-show="open" x-cloak class="fixed inset-0 z-50 flex items-center justify-center p-4">
            ...
            <div x-show="open" x-transition:enter="transition ease-out duration-300" 
                ...
                <div class="bg-gradient-to-r from-red-500 to-pink-600 px-8 py-6">
                    <div class="flex justify-between items-center">
                        <h2 class="text-xl font-bold text-white">Delete Attendance</h2>
                ...
                <div class="p-8">
                    ...
                    <div class="text-center mb-8">
                        ...
                        <p class="text-gray-600 leading-relaxed">
                            Tindakan ini tidak dapat dibatalkan. Ini akan menghapus catatan kehadiran secara permanen.
                        </p>
                    </div>
                    ...
                    @if($attendance_id)
                        <div class="bg-gray-50 rounded-xl p-4 mb-6">
                            <p class="text-sm text-gray-600 text-center">
                                Anda akan menghapus catatan kehadiran dengan ID: <span class="font-semibold text-gray-900">#{{ $attendance_id }}</span>
                            </p>
                        </div>
                    @endif
